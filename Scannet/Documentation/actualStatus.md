...
**Estado: ✅ Implementado. Requiere crear el bucket `tickets` en Supabase Storage (ver abajo).**
...
| Subida de imagen desde galería | ✅ Implementado |
| OCR vía HuggingFace Inference API | ⚠️ Implementado — pendiente prueba con modelo real |
...
| Guardado de imagen en Supabase Storage | ✅ Implementado (requiere bucket `tickets` en Supabase) |
| Categorización automática (DeepSeek) | ✅ Completo (degradación suave si falla) |
| Detección de duplicados | ✅ Corregido — muestra banner en verify, permite editar |
